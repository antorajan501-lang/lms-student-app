...
use Modules\StudentSetting\Entities\StudentApplicationProfile;
...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function studentApplicationProfile(): HasOne
    {
        return $this->hasOne(StudentApplicationProfile::class, 'user_id', 'id');
    }
    ...
    {
        if (StudentVerificationService::isBlocked($this)) {
            return false;
        }
