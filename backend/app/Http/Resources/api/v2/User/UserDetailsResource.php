...
class UserDetailsResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            'id'            => (int)$this->id,
            'verification' => [
                'status' => StudentVerificationService::status($this->resource),
                'label' => StudentVerificationService::label($this->resource),
                'is_verified' => StudentVerificationService::isApproved($this->resource),
                'verified_at' => $this->verified_at ? (string)$this->verified_at : null,
                'rejected_at' => $this->rejected_at ? (string)$this->rejected_at : null,
